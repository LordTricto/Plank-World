...
function animate(){
    ...
    const content7 = document.querySelector(".pitchHead");
    const content8 = document.querySelector(".pitchBody");
    const content9 = document.querySelector(".cta-section");
    const trig1 = document.querySelector(".pitch");
    const content10 = document.querySelector(".carousel");
    const cta1 = document.querySelector(".act1");
    const cta2 = document.querySelector(".act2");
    const title4 = document.querySelector(".review-write");
    const title5 = document.querySelector(".review-write h2");
    const title6 = document.querySelector(".review");
    ...
    const cont10 = TweenMax.fromTo(content7,2, {x: "30", opacity: 0}, {x:0, opacity:1, ease: Power2.easeInOut });
    ...
    const cont11 = TweenMax.fromTo(content8,2, {x: "-80", opacity: 0}, {x:0, opacity:1, ease: Power2.easeInOut });
    ...
    const cont12 = TweenMax.fromTo(cta1,2, {y: "80", opacity: 0}, {y:0, opacity:1, ease: Power2.easeInOut });
    ...
    const cont13 = TweenMax.fromTo(cta2,1, {y: "60", opacity: 0}, {y:0, opacity:1, ease: Power2.easeInOut });
    ...
    const cont14 = TweenMax.fromTo(title4,1, {y: "30", opacity: 0}, {y:0, opacity:1, ease: Power2.easeInOut });
